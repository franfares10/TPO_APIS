...
export default function Encuesta() {
    ...
    return (
        <div>
            <Fab className={classes.fab} color="inherit" variant="extended" href="/companyAdmin/dashboard">
            ...
            <GridContainer direction={"column"} justify={"center"} alignItems={"center"}>
                ...
                <GridItem>
                    <Button className={classes.Button} href="/companyAdmin/dashboard" color="primary">Enviar Respuestas</Button>
                </GridItem>
            </GridContainer>
        </div>
    );
